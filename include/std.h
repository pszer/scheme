...
scheme_object * __Scheme_CallAdd__(scheme_object ** objs, scheme_env * env, size_t count);
scheme_object * __Scheme_CallSub__(scheme_object ** objs, scheme_env * env, size_t count);
scheme_object * __Scheme_CallMul__(scheme_object ** objs, scheme_env * env, size_t count);
scheme_object * __Scheme_CallDiv__(scheme_object ** objs, scheme_env * env, size_t count);
